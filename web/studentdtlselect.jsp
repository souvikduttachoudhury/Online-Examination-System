<%-- 
    Document   : studentdtlselect.jsp
    Created on : Jun 10, 2015, 9:04:39 AM
    Author     : abc
--%>
...
<html>
    ...
    <form id="formsd" name="formsd" action="studentdtls.jsp">
    ...
    <form id="stupdate" method="post" action="studentedit.jsp">            
        <div id="enter_ins_stu" style="margin-top: -50px">
                <div id="usn_ea">Select Institute:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                    <select name="inst_code" id="inst_code">
                        <option value="">&nbsp;&nbsp;&nbsp;Choose
