<%-- 
    Document   : institutedtlselect
    Created on : Jun 10, 2015, 4:06:01 PM
    Author     : abc
--%>
...
<html>
    ...
    <%!int inst_ct=0,student_ct[];%><%!String inst_code[],inst[],name[][];%><%!int student_code[][];%>
    <%
    ...
    <form id="formid" name="formid" action="institutedtls.jsp">
    ...
    <div id="slct_lgn" style="margin-top: 17.5%;margin-left: -10%">
        <a href="javascript:void(0)" id="create" style="height:1.875%;width:200px;background-color: palegreen;text-decoration: none;border-radius: 12px;color:blue;font-family: Calibri;font-weight: normal;padding:0.5px;border-width: 3.5px; font-size:27px;border:1.75px paleturquoise solid" onclick="submit_dtlsid();">&nbsp;&nbsp;Create New&nbsp;&nbsp;</a>
