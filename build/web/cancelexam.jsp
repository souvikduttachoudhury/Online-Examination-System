<%-- 
    Document   : cancelexam
    Created on : Jun 29, 2015, 10:21:15 AM
    Author     : abc
--%>
    ...
    <%
           if(session.getAttribute("code1").equals(null)){%>
            ...
            conn.setAutoCommit(false);
               ...
               ps = conn.prepareStatement("UPDATE OES_EXAM_MST SET EXAM_CANCELLED='Y',UPD_BY='"+username+"' WHERE EXAM_CD="+exam_cd+"");
               ps.executeUpdate();
       ...
       <div style="margin-left:80%; margin-top:-5px" class="bs-example">
        <ul class="nav nav-pills">
            <li class="dropdown">
                ...
                <h1 id="head">Examination Cancelled Succesfully...</h1>
